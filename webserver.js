...
app.post('/searchData', (req, res) => {
	...
	for(var i = 0; i < req.body.departments.length; i++) {
		...
		if (req.body.course_number === '' && req.body.crn === '') {
			getCourses = 'SELECT Sections.waitlist_count, Sections.subject, Sections.course_number, Sections.section_number, Sections.building, Sections.room, Sections.professors, Sections.crn, Sections.capacity, Courses.name, Courses.credits, Courses.description, Sections.times, Sections.registered FROM Sections INNER JOIN Courses ON Courses.course_number = Sections.course_number WHERE Sections.subject = "' + req.body.departments[i].substring(0, 4) + '" and Courses.subject = "' + req.body.departments[i].substring(0, 4)  + '" ORDER BY Sections.course_number ASC, Sections.section_number ASC';
		} else if (req.body.crn === '') {
			getCourses = 'SELECT Sections.waitlist_count, Sections.subject, Sections.course_number, Sections.section_number, Sections.building, Sections.room, Sections.professors, Sections.crn, Sections.capacity, Courses.name, Courses.credits, Courses.description, Sections.times, Sections.registered FROM Sections INNER JOIN Courses ON Courses.course_number = Sections.course_number WHERE Sections.course_number = "' + req.body.course_number + '" AND Sections.subject = "' + req.body.departments[i].substring(0, 4) + '" and Courses.subject = "' + req.body.departments[i].substring(0, 4)  + '" ORDER BY Sections.course_number ASC, Sections.section_number ASC';
		} else if (req.body.course_number === '') {
			getCourses = 'SELECT Sections.waitlist_count, Sections.subject, Sections.course_number, Sections.section_number, Sections.building, Sections.room, Sections.professors, Sections.crn, Sections.capacity, Courses.name, Courses.credits, Courses.description, Sections.times, Sections.registered FROM Sections INNER JOIN Courses ON Courses.course_number = Sections.course_number WHERE Sections.crn = "' + req.body.crn + '" AND Sections.subject = "' + req.body.departments[i].substring(0, 4) + '" and Courses.subject = "' + req.body.departments[i].substring(0, 4)  + '" ORDER BY Sections.course_number ASC, Sections.section_number ASC';
		} else {
			getCourses = 'SELECT Sections.waitlist_count, Sections.subject, Sections.course_number, Sections.section_number, Sections.building, Sections.room, Sections.professors, Sections.crn, Sections.capacity, Courses.name, Courses.credits, Courses.description, Sections.times, Sections.registered FROM Sections INNER JOIN Courses ON Courses.course_number = Sections.course_number WHERE Sections.course_number = "' + req.body.course_number + '" AND Sections.crn = "' + req.body.crn + '" AND Sections.subject = "' + req.body.departments[i].substring(0, 4) + '" and Courses.subject = "' + req.body.departments[i].substring(0, 4) + '" ORDER BY Sections.course_number ASC, Sections.section_number ASC';
		}
